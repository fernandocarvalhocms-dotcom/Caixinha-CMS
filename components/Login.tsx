        ...
        <div className="p-8">
          ...
          {view === 'REGISTER_PASSWORD' && (
            <form onSubmit={handlePasswordSet} className="space-y-6">
              ...
              <button type="submit" disabled={isLoading} className="w-full py-3 px-4 rounded-md text-white bg-green-600 hover:bg-green-700">{isLoading ? 'Registrando...' : 'Finalizar Cadastro'}</button>
            </form>
          )}
        </div>
      </div>
